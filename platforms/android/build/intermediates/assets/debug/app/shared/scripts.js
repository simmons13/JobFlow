...
function SQL(sqlstatement, callback){
...
function gotoView (i_args) {
    ...
    console.error("USER ID:" + appSettings.getString("user"));
    console.error("PROJECT ID:" + appSettings.getString("projects"));
    console.error("CHANGES ID:" + appSettings.getString("changes"));
    console.error("CLIENTS ID:" + appSettings.getString("clients"));
...
function loadForm (i_this) {
    ...
    if (currentAction == "edit") {
        ...
        sqlAction = sqlAction.replace("&cond&", "id="+1 );
